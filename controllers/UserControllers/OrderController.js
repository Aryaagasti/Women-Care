        ...
        res.status(200).json({
          ...
          order: {
            ...
            items: order.items.map((item) => ({
              ...
              productImage: item.product?.image?.length > 0 ? item.product.image[0] : "No Image Available",
...
module.exports = {confirmOrder,cancelOrder,getUserOrders,getOrderDetails,deliveredOrder, ongoingOrder, getOrderById};