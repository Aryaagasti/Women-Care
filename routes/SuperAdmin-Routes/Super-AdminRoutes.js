...
} = require('../../controllers/SuperAdmin-Controllers/SuperAdminController');
...
router.put('/UpdateProfile/:id', superAdminAuthMiddleware, upload.fields([{ name: "profileImage", maxCount: 1 }]), updateAdminProfile);
